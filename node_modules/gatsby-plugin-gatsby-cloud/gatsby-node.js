...
process.env.GATSBY_PREVIEW_INDICATOR_ENABLED = process.env.GATSBY_PREVIEW_INDICATOR_ENABLED || `false`;
...
exports.onPostBuild = async ({
  ...
  await Promise.all([ensureEmittingFileNodesFinished, (0, _buildHeadersProgram.default)(pluginData, pluginOptions), (0, _createSiteConfig.default)(pluginData, pluginOptions), (0, _createRedirects.default)(pluginData, redirects, rewrites), (0, _copyFunctionsManifest.default)(pluginData), (0, _ipc.emitTotalRenderedPageCount)(pages.size)]);
};
